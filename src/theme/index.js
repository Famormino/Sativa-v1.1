export default {
  ...
  colors: {
    text: "#ddc571", // body color and primary color
    text_secondary: "#ddc571", // secondary body color
    ...
    primary: "#D1B356", // primary button and link color
  ...
  text: {
    ...
    heroSecondary: {
      fontSize: [2, null, "25px", null, null, "25px", 7],
